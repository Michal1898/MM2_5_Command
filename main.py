...
class Attempt:
    def __init__(self, your_code="0 0 0 0 0", no_of_digits=5):
        your_code = your_code.split()
        your_code = [int(a) for a in your_code]
        print(f"Your code: {your_code}, {no_of_digits}")
...
match current_game:
    case "new_game":
        ...
        the_attempt = Attempt("1 2 3 4 5", 13)
